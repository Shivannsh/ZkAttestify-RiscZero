...
contract VerifyAttestationDeploy is Script {
    ...
    function run() external {
        ...
        VerifyAttestation verifyAttestation = new VerifyAttestation(verifier);
        console2.log("Deployed VerifyAttestation to", address(verifyAttestation));
